...
const RECEIVED_DOCS = [
  ...
  {
    id: 'questionnaire',
    name: QUESTIONNAIRE_HUB_LABEL,
    status: 'Ready to import',
    type: 'Questionnaire',
    date: 'Mar 5',
    sourceNote: QUESTIONNAIRE_HUB_SOURCE_NOTE,
  },
]
                        ...
                        <div className={styles.tableRows}>
                          {RECEIVED_DOCS.map(doc => (
                            <div key={doc.id} className={styles.tableRow}>
                              ...
                              <span className={styles.tableDocName}>
                                {doc.name}
                                {'sourceNote' in doc && doc.sourceNote && (
                                  <span className={styles.tableDocSourceNote}>{doc.sourceNote}</span>
                                )}
                              </span>
